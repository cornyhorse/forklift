...
test_data = [
    ...
    [3, "Bob Johnson", 35, "$60,000", "A", False, 78.5, "Product Manager with 10+ years experience"],
    ...
    [9, "Henry Taylor", 38, "$90,000", "A", True, 91.0, "Architect with distributed systems expertise"],
