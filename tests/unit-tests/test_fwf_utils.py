...
class TestCreateFwfConfigFromSchema:
    ...
    def test_standard_fwf_schema(self):
        ...
        schema_data = {
            ...
            "x-fwf": {
                ...
                "nulls": {"global": ["", "NULL"], "perColumn": {"name": ["UNKNOWN"]}},
                    ...
                    "schemas": [
                        ...
                        },
                        {
                            ...
                            "fields": [
                                ...
                                {"name": "id", "start": 2, "length": 3, "parquetType": "int64"},
                                {
                                    "name": "data_b",
                                    "start": 5,
                                    "length": 8,
    ...
    def test_conditional_schema_missing_flag_column(self):
        ...
        schema_data = {
            ...
            "x-fwf": {
                "conditionalSchemas": {
                    "schemas": [
                        {"flagValue": "A", "fields": [{"name": "test", "start": 1, "length": 5}]}
                    ]
                }
            },
        }
        ...
        try:
            with pytest.raises(
                ValueError, match="Conditional schemas require flagColumn specification"
            ):
                create_fwf_config_from_schema(temp_path)
        finally:
            temp_path.unlink()
    ...
    def test_schema_with_minimal_fwf_config(self):
        ...
        schema_data = {
            ...
            "type": "object",
            "x-fwf": {"fields": [{"name": "test_field", "start": 1, "length": 10}]},
        }
