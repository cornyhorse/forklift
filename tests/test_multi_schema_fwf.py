...
def test_multi_schema_fwf_processing():
    ...
    header1 = headers[0]
    expected_header_fields = {'record_type', 'batch_date', 'batch_id', 'description', '__line_number__', '__source_file__'}
    ...
    detail1 = details[0]
    expected_detail_fields = {'record_type', 'transaction_id', 'product_code', 'amount_cents',
                             'currency', 'transaction_date', 'quantity', '__line_number__', '__source_file__'}
    ...
    trailer1 = trailers[0]
    expected_trailer_fields = {'record_type', 'record_count', 'total_amount_cents',
                              'currency', 'summary_date', 'notes', '__line_number__', '__source_file__'}
...
def test_multi_schema_arrow_schema_generation():
    ...
    expected_fields = {
        ...
        'batch_date', 'batch_id', 'description',  # Header fields
        'transaction_id', 'product_code', 'amount_cents', 'currency', 'transaction_date', 'quantity',  # Detail fields
        'record_count', 'total_amount_cents', 'summary_date', 'notes',  # Trailer fields
